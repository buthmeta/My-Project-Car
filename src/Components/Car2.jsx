...
const Car2 = () => {
  return (
    <div className="w-full h-screen z-10 relative bg-black bg-car2 bg-cover bg-center  ">
      <div className="w-full h-screen top-0 bottom-0  bg-gradient-to-r from-black black opacity-80  overflow-hidden  ">
        <div className="text-white w-full h-[110%] px-[9%] flex flex-col justify-center">
          ...
          <p className="pt-4">
            The most powerful four-cylinder Lotus car ever made
          </p>
